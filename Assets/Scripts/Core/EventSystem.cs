...
public static class EventSystem
{
    ...
    // Streaming: frase completa lista para TTS con su emoción detectada
    public static UnityEvent<string, EmotionState> OnFraseListaParaTTS = new UnityEvent<string, EmotionState>();
